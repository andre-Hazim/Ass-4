...
def education_button_touch_up_inside(sender):
     ...
     view['school_description_label'].text = "This is a 120 unit (4 year) program. A full year course (indicated by /6.0) is worth 6 units and a half-course counts as 3.0 units."
